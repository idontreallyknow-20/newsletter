...
import { SITE_URL, AUTHOR_DESCRIPTION, CHESS_PROFILES, personJsonLd, breadcrumbJsonLd } from '@/lib/seo'

export const metadata: Metadata = {
  title: 'About Joseph Leung, writer of Daily Brief (dailybriefhq)',
      ...
      <main className="simple" id="main-content">
        <div className="wrap about-grid">
          <div>
            <div className="portrait">
              {hasPortrait
                ...
                ? <img src="/joseph.jpg" alt="Joseph Leung, writer of Daily Brief, in Richmond Hill, Ontario" width={800} height={1000} />
          ...
          <article className="about">
            ...
            <dl className="ledger">
              <div className="ledger-row"><dt className="t-mono">Name</dt><dd>Joseph Leung</dd></div>
